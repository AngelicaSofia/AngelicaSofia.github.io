...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/pdf/olympics/SpeedSkating-1.pdf" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>

Speed skating on a [long track](https://en.wikipedia.org/wiki/Long-track_speed_skating) (400 meters) divides into individual time-based distances and group-oriented races. [Short-track races](https://en.wikipedia.org/wiki/Short-track_speed_skating) such as the 500, 1,000, 1,500, 3,000, 5,000, and 10,000 meters are time trials where athletes skate in pairs against the clock. Success depends on efficiency of stride, power transfer through the clap blade mechanism, and maintaining aerodynamics throughout the race.

But one of the most fascinating formats for a spectator is the [mass start](https://en.wikipedia.org/wiki/Mass_start). Unlike traditional long-track events where skaters race in pairs against time, in mass start all competitors begin together and race head-to-head for position over 16 laps. Intermediate sprints are scored at designated laps, and points determine rankings alongside the final sprint.
...
Speed skating has been part of the Winter Olympic program since the [I Winter Games in 1924 at Chamonix](https://en.wikipedia.org/wiki/1924_Winter_Olympics), with women added officially in 1960.

At the [Milano–Cortina 2026 Games](https://en.wikipedia.org/wiki/2026_Winter_Olympics), 14 events were contested across traditional distances, team pursuit, and mass start for both men and women. In distances up to 10,000 meters, skaters compete in pairs against time, changing lanes each lap to equalize inner and outer lane advantages. For team pursuit, three skaters per team work in coordinated formation to achieve the fastest combined time. For the mass start, all skaters face off together, and intermediate sprint points and final crossing order determine the results.
...
In the men’s mass start, [Andrea Giovannini](https://en.wikipedia.org/wiki/Andrea_Giovannini) secured bronze — a notable milestone that contributed to Italy’s overall medal tally.

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/pdf/olympics/SpeedSkating-3.pdf" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div> ￼
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/sport/speedskating-5.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
...
Italy achieved its best Winter Olympics performance ever at Milano–Cortina 2026, finishing 4th in the medal table with a [record 30 total medals](https://en.wikipedia.org/wiki/Italy_at_the_2026_Winter_Olympics): 10 gold, 6 silver, and 14 bronze, surpassing the previous high of 20 medals set at [Lillehammer 1994](https://en.wikipedia.org/wiki/1994_Winter_Olympics). It was also the largest Italian delegation ever at a Winter Games, with 196 athletes competing across 16 sports. ￼

Highlights:

- **Speed skating**: [Francesca Lollobrigida](https://en.wikipedia.org/wiki/Francesca_Lollobrigida) won gold in the 3000 m on her 35th birthday and again in the 5000 m. [Andrea Giovannini](https://en.wikipedia.org/wiki/Andrea_Giovannini) and [Davide Ghiotto](https://en.wikipedia.org/wiki/Davide_Ghiotto) took gold in the mass start and team pursuit.
- **Short-track**: [Arianna Fontana](https://en.wikipedia.org/wiki/Arianna_Fontana) earned three medals, including silver in the 500 m and success in the mixed relay. She became Italy’s most medaled athlete ever.
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/pdf/olympics/SpeedSkating-4.pdf" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div> ￼
<div class="caption">
...
- [NBC Olympics: Speed Skating Schedule & Preview](https://www.nbcolympics.com/news/speed-skating-2026-milan-cortina-winter-olympic-games)
